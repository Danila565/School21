...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/07 21:34:25 by efelicit          #+#    #+#             */
/*   Updated: 2021/10/07 21:34:25 by efelicit         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#ifndef LIBFT_H
# define LIBFT_H
...
void			ft_lstadd_front(t_list **lst, t_list *mnew);
int				ft_lstsize(t_list *lst);
t_list			*ft_lstlast(t_list *lst);
void			ft_lstadd_back(t_list **lst, t_list *mnew);
